...
using IdentityModel;
namespace QuickstartIdentityServer.User
{
    /// <summary>
    /// 前面的过程都是使用的TestUser来进行测试的，那么我们正式使用时肯定是使用自己定义的用户（从数据库中获取）
    /// ，这里我们可以实现IResourceOwnerPasswordValidator接口，来定义我们自己的验证逻辑
    /// </summary>
